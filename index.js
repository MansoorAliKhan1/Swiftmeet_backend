...
connectMongoDB('mongodb+srv://mansoor17050:Mak@170501@cluster0.yuh5elq.mongodb.net/?retryWrites=true&w=majority').then(()=> console.log("mongodb connected")).catch(err => console.log("mongodb error",err));
